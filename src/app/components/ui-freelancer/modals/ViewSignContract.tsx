...
export default function ViewSignContract(){
    ...
    const isStatusWorkingOrStopped = ContractForm?.status === "doing" || ContractForm?.status === "stopped";
    ...
    return(
        <>
            ...
            >
                ...
                <Paragraph className="text-[#1890FF] underline">{ContractForm?.contract}</Paragraph>
                ...
                >
                <FormInput value={ContractForm?.signature} disabled={isStatusWorkingOrStopped}/>
                </Form.Item>
            </Form>
            </CustomFormModal>
        </>
